...
\begin{document}
	...
	% TODO siendo un plugin VST, como se integra en el DAW?
	

 	Furthermore, a series of effects may be applied to the sample in order to modify the sound that is output. Filters, compressors, delays and reverbs are some of the most common effects you may come across. % TODO explain each effect briefly.
	
	
	\newpage
	\subsection{Motivation}
	% TODO DAWs pueden samplear, pero existen inconvenientes (no puedes evitar el workflow impuesto por el DAW (puede ser mejorado), hay un exceso de utilidades que yo nunca usaria, etc.)
	
	% TODO los pasos esenciales para crear un instrumento sampler son pocos. si se puede implementar con una interfaz que habilite la creación con rapidez, tenemos un instrumento efectivo que sirve para samplear que puede usarse en cualquier DAW
...
%	cargar audio
%	crear subsecciones
%	disparar subsecciones con eventos midi
%	ajustar parametros de playback (adsr, poliphony)
