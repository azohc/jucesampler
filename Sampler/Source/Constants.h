...
// COLORS
static const Colour COLOR_BGDARK = Colour::fromString("FF252420");
static const Colour COLOR_BG =  Colour::fromString("FF544F4C");
static const Colour COLOR_BGLIGHT = Colour::fromString("FFA1988F");
static const Colour COLOR_FG =  Colour::fromString("FFEADED2");
static const Colour COLOR_GRAY = Colour::fromString("FF605B58");
static const Colour COLOR_GRAYLIGHT = Colour::fromString("FFD3D4D9");
static const Colour COLOR_RED = Colour::fromString("FFD62734");
static const Colour COLOR_BLUEDARK = Colour::fromString("FF252D39");
