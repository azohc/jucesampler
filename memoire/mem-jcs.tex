...
\begin{document}
	...
	\begin{itemize}
		...
		\item Chop creation: manual and \textit{automatic} chopping using peak detection algorithms.
    ...
    A table component was included to visualize the amount of chops and some of their details. Initially, the table is empty. Once a chop is created
